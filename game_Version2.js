...
function draw() {
    ...
    drawRect(AI_X, rightPaddleY, PADDLE_WIDTH, PADDLE_HEIGHT, '#fff');
...
function update() {
    ...
    if (
        ...
        ballVelX = BALL_SPEED * Math.cos(angle);
    ...
    if (gameMode === 'ai') {
        ...
        // Keyboard control for second player
        if (keys.ArrowUp) {
...
// Keyboard controls for right paddle when in player mode
